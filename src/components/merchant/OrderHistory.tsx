...
const OrderHistory = () => {
  ...
  return (
    <div>
      ...
      <Container>
        <div className="w-[792px] md:max-w-[792px] lg:max-w-[792px] text-[#717680]   rotate-0 opacity-100 flex flex-col  gap-[16px] ">
          <input
          ...
          <textarea
            rows={5}
            cols={20}
            className="bg-white w-[792px]  max-w-[792px] h-[113px] rounded-[8px]  pt-[8px] pr-[24px] pb-[8px] pl-[24px] gap-[16px] rotate-0 opacity-100 border border-[#B2DDFF] "
          ...
          <select className="bg-white w-full p-[16px] h-[56px] rounded-[8px] border border-[#B2DDFF] pt-[8px] pr-[24px] pb-[8px] pl-[24px] gap-[16px] rotate-0 opacity-100">
          ...
          <div className="flex">
            ...
            <div className="w-full">
              <input className="w-[670px] max-w-[670px]  bg-white p-[16px] h-[56px] rounded-l-0 rounded-[8px] border border-[#B2DDFF] pt-[8px] pr-[24px] pb-[8px] pl-[24px] gap-[16px] rotate-0"></input>
            </div>
          </div>
          <div className="flex">
          ...
          <div className="flex">
            ...
            <div className="w-full">
              <input className="w-[670px]  bg-white p-[16px] h-[56px] rounded-l-0 rounded-[8px] border border-[#B2DDFF] pt-[8px] pr-[24px] pb-[8px] pl-[24px] gap-[16px] rotate-0"></input>
            </div>
          </div>

          <button
            className="bg-[#EF6820] text-white w-[792px] max-w-[793] h-[56px] rounded-[8px] 
