...
const TicketOverview = () => {
  const customerData = [
    { number: 1270, label: "Total tickets" },
    { number: 820, label: "Open tickets" },
    { number: 350, label: "Pending tickets" },
    { number: 120, label: "Resolve tickets" },
  ];
  ...
  return (
    <Container>
      ...
      <ReusableHeading text="Ticket overview"></ReusableHeading>
